...
HEADERS += jsonbutton.h
SOURCES += main.cpp splashscreen.cpp mainwindow.cpp mainwidget.cpp citationselectionwindow.cpp citationselectionwidget.cpp citationdatawindow.cpp citationdatawidget.cpp jsonbutton.cpp
